...
class Database(commands.Cog):
    ...
    # User operations
    def get_user(self, user_id: str, create_if_missing: bool = False) -> Optional[User]:
        """Get a user by ID."""
        if create_if_missing:
    ...
    def get_user_steam_id(self, user_id: str) -> Optional[str]:
        """Get a user's Steam ID."""
        user = self._get_or_create_user(user_id)
        return cast(Optional[str], user.steam_id)

    def set_user_steam_id(self, user_id: str, steam_id: str) -> None:
        """Set a user's Steam ID."""
        user = self._get_or_create_user(user_id)
